...
export default function Transaction(){
    ...
    return(
        ...
        <div className='transactionpage'>
            ...
            <input placeholder='Search transaction name,keyword etc.' className='search' type='text'></input>
        </div>
        ...
        <div className='twocomponents'>
            <div className='transactiondetails1'>
                <table className='table'>
                    ...
                    <tr onClick={()=>onhandlechange(1)} className={`${id==1?"clicked":""} tr`}>
                    ...
                    <tr onClick={()=>onhandlechange(2)} className={`${id==2?"clicked":""} tr`}>
                        <td  className='td'>Jan 15</td>
                        <td>
                            <div className='data'>
                    ...
                    <tr onClick={()=>onhandlechange(3)} className={`${id==3?"clicked":""} tr`}>
                        <td>Jan 16</td>
                        <td>
                    ...
                    <tr onClick={()=>onhandlechange(4)} className={`${id==4?"clicked":""} tr`}>
                        <td>Jan 17</td>
                        <td>
                    ...
                    <tr onClick={()=>onhandlechange(5)} className={`${id==5?"clicked":""} tr`}>
                        <td>Jan 17</td>
                        <td>
                            <div className='pink'></div>
                        </td>
                    ...
                    <tr onClick={()=>onhandlechange(6)} className={`${id==6?"clicked":""} tr`}>
                        <td>Jan 18</td>
                        <td>
                    ...
                    <tr onClick={()=>onhandlechange(7)} className={`${id==7?"clicked":""} tr`}>
                        <td>Jan 19</td>
                        <td>
            ...
            <div className='transactiondetails2'>
                ...
                <div className='remarks'><p className='remarkstext'>REMARKS</p>
                    <div className='note'>
